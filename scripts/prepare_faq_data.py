...
from rag_core.openrouter_client import chat_with_openrouter
...
def main():
    ...
    print(f"Processing {len(documents)} documents for question generation (excluding abbreviations/terms)")
